...
• Write one version of this program that passes the if 
 test and another that fails. (The version that fails will 
 have no output.)
*/
...
if(AlienColor === 'blue'){
  ...
  console.log('');//prints an empty string or nothing
}
